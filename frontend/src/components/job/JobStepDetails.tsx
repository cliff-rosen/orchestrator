...
const JobStepCard: React.FC<JobStepCardProps> = ({ step, index, isExpanded, onToggle, job }) => {
    ...
    const getInputValue = (mapping: string) => {
        console.log('Getting input value for mapping:', mapping, 'from variables:', job.input_variables);
        ...
        if (variable) {
            console.log('Found variable by ID:', variable);
